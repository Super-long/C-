...
class employee : public abstr_emp
{
    public:
        ...
        //virtual void setAll(){cout << "Please enter employee:\n"<<"fname,lname,job.\n";}
        virtual void writeall(std::ofstream & fout){
...
class manager: virtual public abstr_emp
{
    ...
    public:
        ...
        //virtual void setAll(){cout << "Please enter manger:\n"<<"fname,lname,job,inchargeof(int).\n";}
        virtual void writeall(std::ofstream & fout){
            abstr_emp::writeall(fout);
...
class fink: virtual public abstr_emp
{
    ...
    public:
        ...
        //virtual void setAll(){cout << "Please enter fink:\n"<<"fname,lname,job,reportsto.\n";}
        virtual void writeall(std::ofstream & fout){
            abstr_emp::writeall(fout);
            fout << reportsto << endl;
        }
...
class highfink: public manager, public fink
{
    public:
        ...
        virtual void showAll() const;
        virtual void setAll(){abstr_emp::setAll();};
        //virtual void setAll(){cout << "Please enter highfink:\n"<<"fname,lname,job.\n";}
        virtual void writeall(std::ofstream & fout){
            abstr_emp::writeall(fout);
        }
};
